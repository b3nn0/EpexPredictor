...
COUNTRY_CONFIG = {
    Country.DE:  CountryConfig(
        ...
        # 68 locations: 64 land-based + 4 offshore North Sea wind farm locations
        ...
        # SL (3): Saarbrücken, Neunkirchen, Saarlouis
                      49.24, 49.35, 49.31,
        # Offshore North Sea (4): Major wind farm areas
                      54.0, 54.5, 54.3, 54.8],
    ...
    Country.BE : CountryConfig(
        ...
        LATITUDES = [51.22, 51.05, 51.21, 50.88, 50.63, 50.41, 50.47, 50.45, 50.85, 51.03, 50.93, 49.68, 51.6, 51.4, 51.7],
        LONGITUDES = [4.40, 3.72, 3.22, 4.70, 5.57, 4.44, 4.87, 3.95, 4.35, 4.48, 5.33, 5.82, 2.8, 3.0, 2.5],
    ),
    Country.NL : CountryConfig(
        ...
        LATITUDES = [53.22, 53.20, 52.99, 52.37, 52.16, 52.09, 51.99, 52.51, 52.52, 52.42, 51.69, 51.44, 51.56, 51.81, 51.99, 51.44, 51.35, 50.85, 52.5, 52.8, 53.0, 53.3],
        LONGITUDES = [6.57, 5.79, 6.56, 4.90, 4.50, 5.12, 5.89, 6.08, 5.47, 4.62, 4.78, 5.47, 5.09, 5.84, 4.14, 3.61, 6.17, 5.69, 3.5, 4.2, 4.5, 4.8],
    ),
}
