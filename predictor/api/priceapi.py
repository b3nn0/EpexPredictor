    ...
    async def prices(self, hours : int = -1, fixedPrice : float = 0.0, taxPercent : float = 0.0, startTs : datetime.datetime|None = None,
        ...
        if hourly:
            ...
            for dt in sorted(prediction.keys()):
                dt_local = dt.astimezone(tzgerman)
...
class Prices:
    ...
    async def prices(self, hours : int = -1, fixedPrice : float = 0.0, taxPercent : float = 0.0, startTs : datetime.datetime|None = None,
        ...
        return await self.countryPrices[country].prices(hours,fixedPrice, taxPercent, startTs, unit, evaluation, hourly)
...
async def get_prices(
    ...
    """
    return await pricesHandler.prices(hours, fixedPrice, taxPercent, startTs, country, unit, evaluation, hourly)
